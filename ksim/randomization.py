...
__all__ = [
    "PhysicsRandomizer",
    "StaticFrictionPhysicsRandomizer",
    "FloorFrictionPhysicsRandomizer",
    "ArmaturePhysicsRandomizer",
    "MassAdditionPhysicsRandomizer",
    "MassMultiplicationPhysicsRandomizer",
    "JointDampingPhysicsRandomizer",
    "JointZeroPositionPhysicsRandomizer",
]
...
@attrs.define(frozen=True, kw_only=True)
class StaticFrictionPhysicsRandomizer(PhysicsRandomizer):
...
@attrs.define(frozen=True, kw_only=True)
class FloorFrictionPhysicsRandomizer(PhysicsRandomizer):
...
@attrs.define(frozen=True, kw_only=True)
class ArmaturePhysicsRandomizer(PhysicsRandomizer):
...
@attrs.define(frozen=True, kw_only=True)
class MassAdditionPhysicsRandomizer(PhysicsRandomizer):
...
@attrs.define(frozen=True, kw_only=True)
class MassMultiplicationPhysicsRandomizer(PhysicsRandomizer):
    """Randomizes the mass of some body."""
...
@attrs.define(frozen=True, kw_only=True)
class JointDampingPhysicsRandomizer(PhysicsRandomizer):
...
@attrs.define(frozen=True, kw_only=True)
class JointZeroPositionPhysicsRandomizer(PhysicsRandomizer):
