...
class PPOTask(RLTask[Config], Generic[Config], ABC):
    ...
    def get_loss_and_metrics(
        ...
        def loss_and_metrics_fn(
            ...
            logged_trajectories = LoggedTrajectory(
            ...
            return loss, xax.FrozenDict(metrics), logged_trajectories
    ...
    def update_model(
        ...
        indices_by_batch = indices.reshape(self.num_batches, self.rollouts_per_batch)  # (num_batches, rollouts / batch)
