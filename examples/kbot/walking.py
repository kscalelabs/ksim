    ...
    def get_environment(self) -> MjxEnv:
        return MjxEnv(
            ...
            rewards=[
                ...
                OrientationPenalty(scale=-0.1, target_orientation=jnp.array([0.073, 0.0, 1.0])),
                TorquePenalty(scale=-0.1),
                EnergyPenalty(scale=-0.1),
                JointAccelerationPenalty(scale=-0.1),
                FootSlipPenaltyBuilder(
                    scale=-0.1, foot_body_names=["foot1", "foot3"]
                ),
                FeetClearancePenaltyBuilder(
                    scale=-0.1,
                    foot_body_names=["foot1", "foot3"],
                    max_foot_height=0.2,
                ),
                FeetAirTimeRewardBuilder(
                    scale=0.1,
                ...
                DefaultPoseDeviationPenaltyBuilder(
                    scale=-0.1,
                    default_positions={
                        "left_shoulder_pitch_03_ctrl": 0.0,
                        "left_shoulder_roll_03_ctrl": 0.0,
                        "left_shoulder_yaw_02_ctrl": 0.0,
                        "left_elbow_02_ctrl": 0.0,
                        "left_wrist_02_ctrl": 0.0,
                        "right_shoulder_pitch_03_ctrl": 0.0,
                        "right_shoulder_roll_03_ctrl": 0.0,
                        "right_shoulder_yaw_02_ctrl": 0.0,
                        "right_elbow_02_ctrl": 0.0,
                        "right_wrist_02_ctrl": 0.0,
                        "left_hip_pitch_04_ctrl": 0.0,
                        "left_hip_roll_03_ctrl": 0.0,
                        "left_hip_yaw_03_ctrl": 0.0,
                        "left_knee_04_ctrl": 0.0,
                        "left_ankle_02_ctrl": 0.0,
                        "right_hip_pitch_04_ctrl": 0.0,
                        "right_hip_roll_03_ctrl": 0.0,
                        "right_hip_yaw_03_ctrl": 0.0,
                        "right_knee_04_ctrl": 0.0,
                        "right_ankle_02_ctrl": 0.0,
                    },
                    deviation_weights={
                        "left_shoulder_pitch_03_ctrl": 1.0,
                        "left_shoulder_roll_03_ctrl": 1.0,
                        "left_shoulder_yaw_02_ctrl": 1.0,
                        "left_elbow_02_ctrl": 1.0,
                        "left_wrist_02_ctrl": 1.0,
                        "right_shoulder_pitch_03_ctrl": 1.0,
                        "right_shoulder_roll_03_ctrl": 1.0,
                        "right_shoulder_yaw_02_ctrl": 1.0,
                        "right_elbow_02_ctrl": 1.0,
                        "right_wrist_02_ctrl": 1.0,
                        "left_hip_pitch_04_ctrl": 1.0,
                        "left_hip_roll_03_ctrl": 1.0,
                        "left_hip_yaw_03_ctrl": 1.0,
                        "left_knee_04_ctrl": 1.0,
                        "left_ankle_02_ctrl": 1.0,
                        "right_hip_pitch_04_ctrl": 1.0,
                        "right_hip_roll_03_ctrl": 1.0,
                        "right_hip_yaw_03_ctrl": 1.0,
                        "right_knee_04_ctrl": 1.0,
                        "right_ankle_02_ctrl": 1.0,
                    },
                ),
            ],
            observations=[
