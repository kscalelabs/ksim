...
with open("ksim/requirements-eval.txt", "r", encoding="utf-8") as f:
    requirements_eval: list[str] = f.read().splitlines()
...
setup(
    ...
    extras_require={"dev": requirements_dev, "eval": requirements_eval},
