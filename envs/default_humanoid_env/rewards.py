...
def get_reward_fn(reward_params: Dict[str, Dict[str, float]], dt, include_reward_breakdown) -> Callable[[mjxState, jp.ndarray, mjxState], Tuple[jp.ndarray, jp.ndarray, Dict[str, jp.ndarray]]]:
    ...
    """
    def reward_fn(state: mjxState, action: jp.ndarray, next_state: mjxState) -> Tuple[jp.ndarray, jp.ndarray, Dict[str, jp.ndarray]]:
        reward, is_healthy = jp.array(0.), jp.array(1.)
        rewards = {}
...
def forward_reward_fn(state: mjxState, action: jp.ndarray, next_state: mjxState, dt: jax.Array, params: Dict[str, float]) -> Tuple[jp.ndarray, jp.ndarray]:
    ...
    return forward_reward, jp.array(1.) # TODO: ensure everything is initialized in a size 2 array instead...

def healthy_reward_fn(state: mjxState, action: jp.ndarray, next_state: mjxState, dt: jax.Array, params: Dict[str, float]) -> Tuple[jp.ndarray, jp.ndarray]:
...
def ctrl_cost_reward_fn(state: mjxState, action: jp.ndarray, next_state: mjxState, dt: jax.Array, params: Dict[str, float]) -> Tuple[jp.ndarray, jp.ndarray]:
